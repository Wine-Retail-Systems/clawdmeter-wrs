...
#else
// Standard-Build: deutsche Spinner-Wörter (Infinitive). Mischung aus
// "ernsthaft" (Berechnen, Konstruieren) und "verspielt" (Wuseln, Knobeln),
// im Geist der englischen claudepix-Originale aber lokalisiert.
static const char* const anim_messages[] = {
    ...
    "Basteln", "Klügeln", "Brauen",
    "Brüten", "Köcheln", "Marinieren",
    "Sammeln", "Wuseln", "Spähen",
};
#endif
