...
ESP32-S3 firmware for a desk-side Codex usage monitor. Each supported
...
Connects to a host daemon over BLE; daemon polls Anthropic API for usage data. This file is for future Codex sessions to bootstrap quickly. Read this first.
